...
oc create -f /root/openshift-homework/yaml/env-projectlimit.yaml -n beta-task-dev
oc adm new-project beta-task-test --node-selector='client=beta'
oc create -f /root/openshift-homework/yaml/env-projectlimit.yaml -n beta-task-test
oc adm new-project beta-task-prod --node-selector='client=beta'
oc create -f /root/openshift-homework/yaml/env-projectlimit.yaml -n beta-task-prod
